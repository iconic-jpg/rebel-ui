...
export default function App() {
    return (_jsx(Router, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(Login, {}) }), _jsx(Route, { path: "/signup", element: _jsx(Signup, {}) }), _jsxs(Route, { path: "/", element: _jsx(AppShell, {}), children: [_jsx(Route, { index: true, element: _jsx(RebelDashboard, {}) }), _jsx(Route, { path: "inventory", element: _jsx(AssetInventoryPage, {}) }), _jsx(Route, { path: "discovery", element: _jsx(AssetDiscoveryPage, {}) }), _jsx(Route, { path: "cbom", element: _jsx(CBOMPage, {}) }), _jsx(Route, { path: "pqc", element: _jsx(PQCPosturePage, {}) }), _jsx(Route, { path: "pqc-readiness", element: _jsx(PQCReadinessPage, {}) }), _jsx(Route, { path: "rating", element: _jsx(CyberRatingPage, {}) }), _jsx(Route, { path: "reporting", element: _jsx(ReportingPage, {}) })] })] }) }));
}
