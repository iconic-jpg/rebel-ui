    ...
    <div style={{ ...LS.panel }}>
      ...
      <div style={{ padding: 14, display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
        <div style={{ width: 200, height: 120, display: "flex", alignItems: "flex-end", justifyContent: "center", position: "relative" }}>
          <div style={{ width: 180, height: 90, borderRadius: "90px 90px 0 0", border: "14px solid #e2e8f0", borderBottom: "none", background: "transparent", animation: "shimmer 1.4s ease infinite" }} />
...
function LMetricCard({ label, value, sub, color }: { label: string; value: string | number; sub: string; color: string }) {
  return (
    <div style={{ background: L.panelBg, border: `1px solid ${L.panelBorder}`, borderRadius: 8, padding: "14px 16px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
      <div style={{ fontSize: 8, color: L.text4, textTransform: "uppercase" as const, letterSpacing: ".12em", marginBottom: 6 }}>{label}</div>
...
function RoadmapCard({ a, i }: { a: any; i: number }) {
  ...
  return (
    <div style={{ borderBottom: `1px solid ${L.borderLight}`, background: L.panelBg, transition: "background 0.15s" }}
    ...
    >
      <div onClick={() => setOpen(o => !o)} style={{ padding: "10px 14px", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          ...
          <span style={{ fontSize: 8, fontWeight: 700, color: riskVariant(a.risk), border: `1px solid ${riskVariant(a.risk)}44`, borderRadius: 3, padding: "2px 7px", background: `${riskVariant(a.risk)}0d` }}>{a.risk}</span>
          <span style={{ fontSize: 10, color: L.text4 }}>{open ? "▲" : "▼"}</span>
        </div>
      </div>
      <div style={{ padding: "0 14px 10px", display: "flex", gap: 10, flexWrap: "wrap" as const }}>
  ...
  return (
    <div style={LS.page}>
      ...
      <LPanel>
        ...
        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 10 }}>
            <div>
              <div style={{ fontSize: 8, color: L.text3, letterSpacing: ".12em", marginBottom: 5, textTransform: "uppercase" as const, fontWeight: 600 }}>CLIENT DOMAIN</div>
              <div style={{ display: "flex", gap: 6 }}>
            ...
            <div>
              <div style={{ fontSize: 8, color: L.text3, letterSpacing: ".12em", marginBottom: 5, textTransform: "uppercase" as const, fontWeight: 600 }}>CLIENT NAME (for PDF)</div>
                ...
                <div style={{ padding: 14, display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
                  ...
                  <div style={{ width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                    {[
                      ...
                      <div key={item.label} style={{ background: L.subtleBg, border: `1px solid ${L.border}`, borderRadius: 5, padding: isMobile ? "6px 4px" : "8px 6px", textAlign: "center" as const }}>
                ...
                <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 12 }}>
                  <div style={{ display: "grid", gridTemplateColumns: (isTablet || isDesktop) ? "1fr 1fr" : "1fr", gap: 10 }}>
                    <div style={{ background: L.subtleBg, border: `1px solid ${L.border}`, borderRadius: 5, padding: 12 }}>
                      <div style={{ fontSize: 8, color: L.text3, marginBottom: 5, letterSpacing: ".12em", textTransform: "uppercase" as const, fontWeight: 600 }}>ESTIMATED COMPLETION</div>
                    ...
                    <div style={{ background: "#fff5f5", border: `1px solid ${L.red}22`, borderRadius: 5, padding: 12 }}>
                      <div style={{ fontSize: 8, color: L.text3, marginBottom: 5, letterSpacing: ".12em", textTransform: "uppercase" as const, fontWeight: 600 }}>TOTAL MIGRATION COST</div>
                    ...
                    {[
                      ...
                      <div key={sl.label}>
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                          <span style={{ fontSize: 9, color: L.text3, letterSpacing: ".1em", textTransform: "uppercase" as const, fontWeight: 600 }}>{sl.label}</span>
                ...
                return (
                  <div key={level} style={{ background: bg, border: `1px solid ${color}22`, borderRadius: 6, padding: 12 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                      <span style={{ fontSize: 9, color, letterSpacing: ".12em", fontWeight: 700, textTransform: "uppercase" as const }}>{level}</span>
      ...
      <LPanel>
          ...
          !loading && (
            <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
              ...
              <button
                ...
                onClick={() => exportAuditPDF({ enriched, migrationScore, pqcReady, total, totalDays, calDays, totalCostINR: totalCost, teamSize, devRateINR: devRate, completionDate: dateStr, clientName, clientDomain: activeDomain, milestones })}
                  ...
                  : enriched.map((a: any, i: number) => {
                      ...
                      return (
                        <tr key={i} style={{ borderBottom: `1px solid ${L.borderLight}`, background: i % 2 === 0 ? L.panelBg : L.subtleBg }}
                          ...
                          <td style={{ padding: "7px 8px" }}><span style={{ fontSize: 8, fontWeight: 700, color: riskColor, background: riskBg, border: `1px solid ${riskColor}33`, borderRadius: 3, padding: "1px 6px" }}>{a.risk}</span></td>
        ...
        <div style={{ padding: "8px 14px", borderTop: `1px solid ${L.borderLight}`, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" as const, gap: 8, background: L.subtleBg, borderRadius: "0 0 8px 8px" }}>
          {loading
            ? <Shimmer w={220} h={10} />
            : <>
            ...
            : [
                ...
                <div key={section.title} style={{ background: section.bg, border: `1px solid ${section.border}`, borderRadius: 6, padding: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                    ...
                    <span style={{ fontSize: 9, color: section.color, letterSpacing: ".1em", textTransform: "uppercase" as const, fontWeight: 700, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{section.title}</span>
