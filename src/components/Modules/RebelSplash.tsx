...
export default function RebelSplash() {
  ...
  return (
    <>
      ...
      <div className={`rebel-root${done ? " rebel-exit" : ""}`}>
        ...
        {/* Logo */}
        <div className="rebel-logo-wrap">
          <div className="rebel-orbit-ring rebel-ring-outer" />
          <div className="rebel-orbit-ring rebel-ring-mid" />
          <div className="rebel-orbit-ring rebel-ring-inner" />

          <svg
            className="rebel-hex-svg"
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
          >
            <defs>
              <radialGradient id="rebel-core-glow" cx="50%" cy="50%" r="50%">
                <stop offset="0%"   stopColor="#aaf0ff" />
                <stop offset="40%"  stopColor="#00aaff" />
                <stop offset="100%" stopColor="#002244" />
              </radialGradient>
              <radialGradient id="rebel-mid-glow" cx="50%" cy="50%" r="50%">
                <stop offset="0%"   stopColor="#003366" />
                <stop offset="100%" stopColor="#000e1c" />
              </radialGradient>
            </defs>
            <polygon points="100,10 175,52.5 175,147.5 100,190 25,147.5 25,52.5" fill="#000e1c" stroke="#00c8ff" strokeWidth="2"/>
            <polygon points="100,34 155,65 155,135 100,166 45,135 45,65" fill="#001122" stroke="#0088cc" strokeWidth="1.2"/>
            <polygon points="100,58 138,80 138,122 100,144 62,122 62,80" fill="url(#rebel-mid-glow)" stroke="#0099dd" strokeWidth="1"/>
            <polygon points="100,72 124,86 124,114 100,128 76,114 76,86" fill="url(#rebel-core-glow)"/>
            <circle cx="100" cy="100" r="22" fill="#77ddff" opacity=".9"/>
            <circle cx="100" cy="100" r="15" fill="#cceeff" opacity=".95"/>
            <line x1="100" y1="80"  x2="100" y2="120" stroke="white" strokeWidth=".8" opacity=".7"/>
            <line x1="82"  y1="90"  x2="118" y2="110" stroke="white" strokeWidth=".8" opacity=".7"/>
            <line x1="82"  y1="110" x2="118" y2="90"  stroke="white" strokeWidth=".8" opacity=".7"/>
            <circle cx="100" cy="100" r="50" fill="none" stroke="#0099cc" strokeWidth=".6" strokeDasharray="6,4">
        ...
        {/* Brand */}
        <div className="rebel-brand">
          <p className="rebel-name">REBEL</p>
          <p className="rebel-sub">systems &nbsp;·&nbsp; initializing</p>
          <div className="rebel-divider" />
        </div>

        {/* Loading bar */}
        <div className="rebel-bar-wrap">
          <div className="rebel-bar" style={{ width: `${Math.min(progress, 100)}%` }} />
        </div>
        <p className={`rebel-load-text${done ? " rebel-online" : ""}`}>
          {BOOT_MESSAGES[msgIndex]}
        </p>

        {!done && (
          <div className="rebel-dots">
