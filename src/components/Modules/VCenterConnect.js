...
function Metric({ label, value, sub }) {
    return (_jsxs("div", { style: { flex: 1, minWidth: 0, background: L.accentDim,
            border: `1px solid ${L.accentBorder}`, borderRadius: 8, padding: "12px 14px" }, children: [_jsx("div", { style: { fontFamily: FO, fontSize: 7, color: L.textMuted, letterSpacing: ".16em", fontWeight: 700, marginBottom: 6 }, children: label.toUpperCase() }), _jsx("div", { style: { fontFamily: FO, fontSize: 20, fontWeight: 700, color: L.text, lineHeight: 1 }, children: value }), sub && _jsx("div", { style: { fontFamily: FM, fontSize: 10, color: L.textFaint, marginTop: 4 }, children: sub })] }));
}
...
function RBtn({ children, onClick, disabled, variant = "primary", style: xs = {} }) {
    ...
    return (_jsx("button", { onClick: disabled ? undefined : onClick, style: { ...base, ...variants[variant], ...xs }, children: children }));
}
function RTable({ rows = [], cols }) {
    ...
    return (_jsx("div", { style: { overflowX: "auto" }, children: _jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [_jsx("thead", { children: _jsx("tr", { children: cols.map(c => (_jsx("th", { style: {
                            ...
                            }, children: c.label }, c.key))) }) }), _jsx("tbody", { children: rows.map((row, i) => (_jsx("tr", { style: { borderBottom: `1px solid rgba(14,165,233,0.06)`, transition: "background 0.1s" }, onMouseEnter: e => (e.currentTarget.style.background = L.accentDim), onMouseLeave: e => (e.currentTarget.style.background = "transparent"), children: cols.map(c => (_jsx("td", { style: {
                                padding: "8px 10px", verticalAlign: "middle",
                                fontFamily: FM, fontSize: 11, color: L.textSec,
                            }, children: c.render ? c.render(row[c.key], row) : (row[c.key] != null ? String(row[c.key]) : "—") }, c.key))) }, i))) })] }) }));
}
function Tabs({ tabs, active, onChange }) {
    return (_jsx("div", { style: { display: "flex", borderBottom: `1px solid ${L.divider}`, marginBottom: 16 }, children: tabs.map(t => {
...
const tb = (text, bg, bd, c) => (_jsx("span", { style: { fontFamily: FO, fontSize: 6.5, fontWeight: 700, padding: "2px 7px",
        borderRadius: 3, background: bg, border: `1px solid ${bd}`, color: c, letterSpacing: ".1em" }, children: text }));
...
export default function VCenterConnect({ apiBase = "https://r3bel-production.up.railway.app", onAssets, ghostMode = false, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { style: { minHeight: "100vh", background: L.pageBg, padding: "24px 24px 24px 64px", fontFamily: FM }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }, children: [_jsx("div", { style: {
                                ...
                                }, children: "\u2B21" }), _jsxs("div", { children: [_jsx("h1", { style: { fontFamily: FO, fontWeight: 900, fontSize: 18, color: L.text, letterSpacing: ".12em", lineHeight: 1, margin: 0 }, children: "VCENTER CONNECT" }), _jsx("div", { style: { fontFamily: FM, fontSize: 10, color: L.textFaint, marginTop: 4 }, children: "VMware vCenter \u00B7 Centralized Asset Discovery \u00B7 Air-Gap Compatible" })] }), ghostMode && _jsx(Badge, { label: "Ghost Mode", variant: "ghost" })] }), _jsxs("div", { style: {
                            display: "grid",
                            gridTemplateColumns: session?.connected ? "300px 1fr" : "380px",
                            gap: 16,
                            alignItems: "start",
                        }, children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [_jsxs("div", { style: {
                                            ...
                                            borderRadius: 10, padding: "14px 18px", animation: "fadeSlide 0.2s ease",
                                                ...
                                                }, children: [_jsx("span", { style: { fontFamily: FO, fontSize: 7, color: L.textMuted, letterSpacing: ".14em", fontWeight: 700 }, children: k }), _jsx("span", { style: { fontFamily: FM, fontSize: 11, color: L.textSec }, children: v })] }, k)))] }))] }), session?.connected && (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12, animation: "fadeSlide 0.3s ease" }, children: [_jsxs("div", { style: { background: L.panelBg, border: `1px solid ${L.divider}`, borderRadius: 10, overflow: "hidden" }, children: [_jsxs("div", { style: {
                                                    padding: "14px 18px", borderBottom: `1px solid ${L.divider}`,
                                                    display: "flex", alignItems: "center", justifyContent: "space-between",
                                                }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [_jsx(PingDot, {}), _jsxs("div", { children: [_jsx("div", { style: { fontFamily: FO, fontWeight: 700, fontSize: 10, color: L.text, letterSpacing: ".1em" }, children: session.full_name || session.host }), _jsxs("div", { style: { fontFamily: FM, fontSize: 10, color: L.textFaint, marginTop: 2 }, children: [session.host, " \u00B7 port ", port] })] })] }), _jsx(Badge, { label: "Connected", variant: "success" })] }), _jsxs("div", { style: { padding: 18 }, children: [_jsxs("div", { style: { display: "flex", gap: 10, marginBottom: 16 }, children: [_jsx(Metric, { label: "Virtual Machines", value: session.vm_count ?? "—", sub: "discovered" }), _jsx(Metric, { label: "vCenter", value: session.vcenter_version ?? "—", sub: "version" }), _jsx(Metric, { label: "Mode", value: demoMode ? "DEMO" : "LIVE", sub: demoMode ? "simulated" : "air-gap ok" })] }), (session.vm_preview?.length ?? 0) > 0 && (_jsxs("div", { children: [_jsx(OLabel, { children: "VM Preview (first 5)" }), session.vm_preview.map((vm, i, a) => (_jsxs("div", { style: {
                                                                    ...
                                                                    borderBottom: i < a.length - 1 ? `1px solid rgba(14,165,233,0.07)` : "none",
                                                                        ...
                                                                        } }), _jsx("span", { style: { fontFamily: FM, fontSize: 11, fontWeight: 500, minWidth: 150, color: L.textSec }, children: vm.name }), _jsxs("span", { style: { fontFamily: FM, fontSize: 10, color: L.textFaint, flex: 1 }, children: [vm.ip || "no IP", " \u00B7 ", vm.os] }), vm.cluster && clusterBadge(vm.cluster)] }, i)))] })), _jsx(RBtn, { onClick: () => handleFetchAssets(false), disabled: loadingAssets, style: { marginTop: 16, width: "100%" }, children: loadingAssets ? "FETCHING ASSETS…" : "FETCH ALL ASSETS ↗" })] })] }), assets && (_jsxs("div", { style: {
                                            background: L.panelBg, border: `1px solid ${L.divider}`,
                                            borderRadius: 10, overflow: "hidden", animation: "fadeSlide 0.25s ease",
                                        }, children: [_jsxs("div", { style: {
                                                    padding: "14px 18px", borderBottom: `1px solid ${L.divider}`,
                                                    display: "flex", alignItems: "center", justifyContent: "space-between",
                                                }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [_jsx(IBox, { icon: "\u25A6", active: true }), _jsx("span", { style: { fontFamily: FO, fontSize: 9, fontWeight: 700, letterSpacing: ".18em", color: L.text }, children: "ASSET INVENTORY" })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsxs("span", { style: { fontFamily: FM, fontSize: 10, color: L.textFaint }, children: [assets.source === "mock" ? "demo dataset" : assets.host, assets.fetched_at && ` · ${new Date(assets.fetched_at).toLocaleTimeString()}`] }), _jsx(RBtn, { variant: "secondary", onClick: () => handleFetchAssets(true), disabled: loadingAssets, style: { padding: "4px 10px", fontSize: 7 }, children: loadingAssets ? "…" : "↻ RESCAN" })] })] }), _jsxs("div", { style: { padding: 18 }, children: [_jsxs("div", { style: { display: "flex", gap: 10, marginBottom: 20 }, children: [_jsx(Metric, { label: "VMs", value: assets.summary?.total_vms ?? 0, sub: `${assets.summary?.powered_on ?? 0} running` }), _jsx(Metric, { label: "Datastores", value: assets.summary?.total_datastores ?? 0 }), _jsx(Metric, { label: "Clusters", value: assets.summary?.total_clusters ?? 0 }), _jsx(Metric, { label: "Networks", value: assets.summary?.total_networks ?? 0 })] }), _jsx(Tabs, { tabs: tabConfig, active: activeTab, onChange: setActiveTab }), activeTab === "vms" && (_jsx(RTable, { rows: assets.virtual_machines ?? [], cols: [
