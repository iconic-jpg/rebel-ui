...
export default function Login() {
    ...
    useEffect(() => {
        ...
        fetch(`${API}/api/token/refresh/`, {
            ...
            .then(res => { if (!res.ok)
            throw new Error(); return res.json(); })
            .then(data => {
