      ...
      <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            ...
            <div>
              <div style={{ fontFamily:"'Orbitron',monospace", fontWeight:900,
                fontSize:14, color:"#fff", letterSpacing:".22em" }}>REBEL</div>
              <div style={{ fontSize:7, color:"rgba(200,220,255,0.2)",
        ...
        <div style={{ padding:"10px 14px 12px",
          ...
          <div style={{ display:"flex", alignItems:"center", gap:7, marginBottom:5 }}>
            ...
            <span style={{ fontSize:7.5, fontFamily:"'Orbitron',monospace",
              color:"#22c55e", letterSpacing:".12em" }}>LIVE · CONNECTED</span>
          </div>
          <div style={{ fontSize:7.5, color:"rgba(200,220,255,0.14)",
